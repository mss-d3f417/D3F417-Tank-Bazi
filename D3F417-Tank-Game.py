...
pygame.display.set_caption('Tank War Game By D3F417')
...
def game_controls():
    ...
    while gcont:
        ...
        button("Bazi kon", 150, 500, 100, 50, green, light_green, action="play")
        button("Safhe Asli", 350, 500, 100, 50, yellow, light_yellow, action="main")
        button("Sik", 550, 500, 100, 50, red, light_red, action="quit")
...
def pause():
    paused = True
    message_to_screen("Stop Shodam", introcolor, -100, size="large")
...
def game_over():
    ...
    while game_over:
        ...
        gameDisplay.fill(black)
        message_to_screen("Bakhti", white, -100, size="large")
        message_to_screen("Mordi Noob Sag.", wheat, -30)

        button("Dobare Zaje Bzn", 150, 500, 150, 50, wheat, light_green, action="play")
        button("Cotrol Kiri", 350, 500, 100, 50, wheat, light_yellow, action="controls")
        button("Sik Biron", 550, 500, 100, 50, wheat, light_red, action="quit")
...
def you_win():
    ...
    while win:
        ...
        gameDisplay.fill(black)
        message_to_screen("Bordi Kiri!", white, -100, size="large")
        message_to_screen("Hala Bokon Konet!", wheat, -30)
...
def gameLoop():
    ...
    while not gameExit:
        ...
        if gameOver == True:
            message_to_screen("BAKHTI", red, -50, size="large")
            message_to_screen("Bzn C Dobare nnt Gaiiede Beshe or Q to Sik", black, 50)
            pygame.display.update()
            while gameOver == True:
                for event in pygame.event.get():
                    if event.type == pygame.QUIT:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_c:
                    ...
                    quit()
        gameDisplay.fill(black)
        message_to_screen("Welcome Be Tank War!", introcolor, -100, size="large")
        message_to_screen("Madare Tank Doshmano Bega", wheat, 15)
        message_to_screen("Ghable Inke Madareto Begad!", wheat, 60)
        message_to_screen("In Bazi Ro D3F417 Sakhte! Ba Esgh Faravan :)", wheat, 110)
        

        button("Bazi Kon", 150, 500, 100, 50, wheat, light_green, action="play",size="vsmall")
        button("Control Kiri", 350, 500, 100, 50, wheat, light_yellow, action="controls",size="vsmall")
        button("Sik", 550, 500, 100, 50, wheat, light_red, action="quit",size="vsmall")
